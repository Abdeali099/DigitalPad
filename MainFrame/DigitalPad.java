 ...
 public class DigitalPad extends JFrame implements ActionListener,KeyListener,Runnable
{
	...
	// Step 1 :- Declare All Component// 
	 ...
	 public JTextArea MainTextArea,NumOfLine;  // MainTextArea->text will written , NumOfLine->Number of Line will written here
...
MainScrollPane = new JScrollPane(MainTextArea,JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);	
		                                 		
									MainTextArea.addKeyListener(this);
									
							/* MainTextArea.setLineWrap(true); // :- Yt :- use For Line Automatialny goes new line
...
//  Step 6 :- Adding MenuBar  On Frame //		         		
		  ...
		  //  Step 6.2 :- Add Menues In MenuBar //      					      					
		         	 ...
		         	 bar.add(file);   bar.add(Edit);  bar.add(View);  bar.add(Advance); bar.add(HelpS); // -> This Are Menuse
...
file.ne.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N,InputEvent.CTRL_MASK,true));  // --> Is : (ctrl + x ) , Work if :-all condition

file.NewWind.setMnemonic(KeyEvent.VK_N); // --> Is : (alt + x ) , Work if :- Menu is Open		
file.NewWind.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N,InputEvent.CTRL_MASK+InputEvent.SHIFT_MASK,true));  // --> Is : (ctrl+ shift + x ) , Work if :-all condition

file.op.setMnemonic(KeyEvent.VK_O); // --> Is : (alt + x ) , Work if :- Menu is Open
file.op.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_O,InputEvent.CTRL_MASK,true));  // --> Is : (ctrl + x ) , Work if :-all condition

file.sa.setMnemonic(KeyEvent.VK_S); // --> Is : (alt + x ) , Work if :- Menu is Open
file.sa.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S,InputEvent.CTRL_MASK,true));  // --> Is : (ctrl + x ) , Work if :-all condition

file.sas.setMnemonic(KeyEvent.VK_S); // --> Is : (alt + x ) , Work if :- Menu is Open		
file.sas.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S,InputEvent.CTRL_MASK+InputEvent.SHIFT_MASK,true));  // --> Is : (ctrl + shift + x ) , Work if :-all condition

file.prn.setMnemonic(KeyEvent.VK_P); // --> Is : (alt + x ) , Work if :- Menu is Open
file.prn.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_P,InputEvent.CTRL_MASK,true));  // --> Is : (ctrl + x ) , Work if :-all condition


file.ex.setMnemonic(KeyEvent.VK_E); // --> Is : (alt + x ) , Work if :- Menu is Open		
file.ex.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_E,InputEvent.CTRL_MASK+InputEvent.SHIFT_MASK,true));  // --> Is : (ctrl+ shift + x ) , Work if :-all condition


//Step   6.3.2 -> Making Shortcuts For Edit Menu's Items //   

Edit.Copy.setMnemonic(KeyEvent.VK_C); // --> Is : (alt + x ) , Work if :- Menu is Open
Edit.Copy.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C,InputEvent.CTRL_MASK,true));  // --> Is : (ctrl + x ) , Work if :-all condition

Edit.Paste.setMnemonic(KeyEvent.VK_P); // --> Is : (alt + x ) , Work if :- Menu is Open		
Edit.Paste.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_V,InputEvent.CTRL_MASK,true));  // --> Is : (ctrl+ shift + x ) , Work if :-all condition

Edit.Cut.setMnemonic(KeyEvent.VK_T); // --> Is : (alt + x ) , Work if :- Menu is Open
Edit.Cut.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_X,InputEvent.CTRL_MASK,true));  // --> Is : (ctrl + x ) , Work if :-all condition

Edit.SelectAll.setMnemonic(KeyEvent.VK_A); // --> Is : (alt + x ) , Work if :- Menu is Open
Edit.SelectAll.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A,InputEvent.CTRL_MASK,true));  // --> Is : (ctrl + x ) , Work if :-all condition

Edit.Replace.setMnemonic(KeyEvent.VK_R); // --> Is : (alt + x ) , Work if :- Menu is Open		
Edit.Replace.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R,InputEvent.CTRL_MASK,true));  // --> Is : (ctrl + shift + x ) , Work if :-all condition

Edit.Find.setMnemonic(KeyEvent.VK_F); // --> Is : (alt + x ) , Work if :- Menu is Open
Edit.Find.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F,InputEvent.CTRL_MASK,true));  // --> Is : (ctrl + x ) , Work if :-all condition

//Step   6.3.1 -> Making Shortcuts For View  Menu's Items //

View.Fonts.setMnemonic(KeyEvent.VK_F); // --> Is : (alt + x ) , Work if :- Menu is Open		
View.Fonts.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F,InputEvent.CTRL_MASK+InputEvent.SHIFT_MASK,true));  // --> Is : (ctrl+ shift + x ) , Work if :-all condition

View.Theme.setMnemonic(KeyEvent.VK_T); // --> Is : (alt + x ) , Work if :- Menu is Open		
View.Theme.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_T,InputEvent.CTRL_MASK+InputEvent.SHIFT_MASK,true));  // --> Is : (ctrl+ shift + x ) , Work if :-all condition
...
Advance.AutoSave.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S,InputEvent.ALT_MASK+InputEvent.SHIFT_MASK,true));  // --> Is : (ctrl+ shift + x ) , Work if :-all condition
...
file.ex.addActionListener(this);  file.NewWind.addActionListener(this); file.op.addActionListener(this); file.ne.addActionListener(this); file.sa.addActionListener(this); file.sas.addActionListener(this); file.prn.addActionListener(this); 

             //Edit Menu Items //

Edit.Copy.addActionListener(this);  Edit.Paste.addActionListener(this);  Edit.Cut.addActionListener(this);   Edit.SelectAll.addActionListener(this); Edit.Replace.addActionListener(this); Edit.Find.addActionListener(this);
	
                   //View Menu Items //

View.Fonts.addActionListener(this); View.Theme.addActionListener(this); 
...
HelpS.Help.addActionListener(this); HelpS.About.addActionListener(this);
...
//   this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); // -> Coumplsoury							
				...
				public Void Exit()
		{
		  ...
		  if(MyTitle.charAt(0)=='*')
			...
			int select=JOptionPane.showConfirmDialog(this,"Do You Want To Save Changes?","DigitalPad",JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE);
		      			...
		      			{ 
		      				    	      FileDialog fd = new FileDialog(this,"Save A FILE",FileDialog.SAVE);//-> Sub window open for Save 
		      											...
		      											fnaTemp="NoName-DigitalPad";
		      											 ...
		      											 {
		      												    FoldTemp=foldS;          fnaTemp=fnaS; FoldTemp=foldS;  // class Varible
		      											...
		      											this.dispose();
		      											this.FindWord.dispose(); this.AboutPad.dispose();
		      											this.RAW.dispose();  this.AutoSave.dispose(); 
		      											this.editFonts.dispose();   this.editTheme.dispose();                       
		      											 } // if close
		      			           ...
		      			           catch(Exception e) {  System.out.println("\n ERROR : "+e.getMessage());  } // catch is close.. 
		            ...
		            // =========================================== //
		              ...
		              else if(select==1)
		              {
		            	  ...
		            	  this.editFonts.dispose();   this.editTheme.dispose();                       
		            	  // I DO this Cause If I Seclect close than after I select cancel there no to anything so
...
// ********************************************************************************************************************* //
		...
		else if(s.equals("Open"))
		{
		 AutoSaveStatusOnFrame=false; // To Stop Auto Save On Starting
			...
			try
			{
			            FileDialog fd = new FileDialog(this, "Open a File", FileDialog.LOAD); // -> open sub window for open files.. 
			            				   fd.setVisible(true);
			...
			catch(Exception e)  {  System.out.println(" ERROR : "+e.getMessage()); }  // catch close
				                            ...
				                            if(foldS!=null &&  fnaS!=null)
											 {
				                            	...
				                            	FoldTemp=foldS;          fnaTemp=fnaS; FoldTemp=foldS;  FoldTemp=foldS;   // class Varible
...
Desktop Browser=Desktop.getDesktop();
       ...
       try
		{
		Browser.browse(new URI("https://www.bing.com/search?q=get+help+with+notepad+in+windows&filters=guid:%224466414-en-dia%22%20lang:%22en%22&form=T00032&ocid=HelpPane-BingIA"));
		}
